...
const Add:React.FC<AddProps> = ({loading,back,logout,add}) =>{
  ...
  const messageRef = useRef<TextAreaType>(null)// rc-textarea
    ...
    <Layout>
      ...
      <div className={styles.add}>
        ...
        <div className={styles.input_area}>
          <Input placeholder='Title' className={styles.input} ref={titleRef} ></Input>
        </div>
        ...
        <div className={styles.input_area}>
          <TextArea className={styles.input} rows={4} placeholder='Comment' ref={messageRef}/>
        </div>
        ...
        <div>
          <Input className={styles.input}  placeholder='Author' ref={authorRef}></Input>
        </div>
        ...
        <div className={styles.input_area}>
          <Input className={styles.input} placeholder='URL' ref={urlRef}></Input>
        </div>
  ...
  function click(){
    ...
    //const message = titleRef.current!.state.value
