...
const Book: React.FC<BookProps> = ({bookId,title,author,createAt,url,deleteBook,goEdit}) =>{
  return(
    <div className={styles.book}>
      <div className={styles.title}>
        <Link to={`/book/${bookId}`} className={styles.title}>
          <BookOutlined /> {title}
        </Link>
      </div>
      ...
      <div className={styles.created}>{moment(createAt).format('MM-DD-YYYY hh:mm a')}</div>
      ...
      <div className={styles.tooltips}>
        ...
        <Tooltip title ='Edit'>
          <Button size='small'  onClick={clickEdit} shape='circle' icon={<EditOutlined/>} className={styles.button_edit}/>
        </Tooltip>
